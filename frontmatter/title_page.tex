...
\textsc{\LARGE No figures yet}\\[1.5cm] % Name of your university/college
...
\HRule \\[0.4cm]
{ \huge \bfseries Olympiad Book}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
Nabin \textsc{Kalauni}\\
\and
Sandesh \textsc{Parajuli}\\
\and
Laxman \textsc{Bista}\\ [5cm]
%----------------------------------------------------------------------------------------
%	DATE SECTION
%----------------------------------------------------------------------------------------
